patterns = {
    ...
    "phee": {
        "Adverse_event": {
            ...
            "keywords": [],
            "event description": "The event involves a negative or harmful outcome associated with a treatment or drug.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The subject {ROLE_Subject} with characteristics such as age {ROLE_Subject_Age}, disorder {ROLE_Subject_Disorder}, gender {ROLE_Subject_Gender}, population {ROLE_Subject_Population}, and race {ROLE_Subject_Race}, experiences an adverse effect {ROLE_Effect} after treatment {ROLE_Treatment}, which includes drug {ROLE_Treatment_Drug}, dosage {ROLE_Treatment_Dosage}, duration {ROLE_Treatment_Duration}, frequency {ROLE_Treatment_Freq}, route {ROLE_Treatment_Route}, and time elapsed {ROLE_Treatment_Time_elapsed}. Combination drug {ROLE_Combination_Drug} may also be involved.",
            "valid roles": [
                "Combination_Drug",
                "Effect",
                "Subject",
        ...
        "Potential_therapeutic_event": {
            ...
            "keywords": [],
            "event description": "The event involves a treatment or drug that shows potential therapeutic effects.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The subject {ROLE_Subject}, characterized by age {ROLE_Subject_Age}, disorder {ROLE_Subject_Disorder}, gender {ROLE_Subject_Gender}, population {ROLE_Subject_Population}, and race {ROLE_Subject_Race}, experiences a potential therapeutic effect {ROLE_Effect} after treatment {ROLE_Treatment}, including drug {ROLE_Treatment_Drug}, dosage {ROLE_Treatment_Dosage}, duration {ROLE_Treatment_Duration}, frequency {ROLE_Treatment_Freq}, route {ROLE_Treatment_Route}, and time elapsed {ROLE_Treatment_Time_elapsed}. Combination drug {ROLE_Combination_Drug} may also contribute.",
            "valid roles": [
                "Combination_Drug",
                "Effect",
                "Subject",
    ...
    "mlee": {
        "Acetylation": {
            ...
            "keywords": [],
            "event description": "Acetylation is a biochemical process where an acetyl group is added to a molecule, typically a protein, impacting its function and activity.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "Theme {ROLE_Theme} undergoes acetylation.",
            "valid roles": ['Theme'],
        },
        "Binding": {
            "event type": "Binding",
            "keywords": [],
            "event description": "Binding refers to the specific interaction between two or more molecules, where they form a complex, typically through non-covalent interactions.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At the site {ROLE_Site}, the theme {ROLE_Theme} binds with {ROLE_Theme2}.",
            "valid roles": ['Site', 'Theme', 'Theme2'],
        },
        "Blood_vessel_development": {
            "event type": "Blood_vessel_development",
            "keywords": [],
            "event description": "Blood vessel development refers to the biological process by which new blood vessels form, grow, and mature within an organism.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At Loc {ROLE_AtLoc}, from Loc {ROLE_FromLoc}, the theme {ROLE_Theme} undergoes blood vessel development.",
            "valid roles": ['AtLoc', 'FromLoc', 'Theme'],
        },
        "Breakdown": {
            "event type": "Breakdown",
            "keywords": [],
            "event description": "Breakdown refers to the process where a molecule or structure undergoes degradation, resulting in its fragmentation or loss of functional integrity.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "Theme {ROLE_Theme} undergoes breakdown.",
            "valid roles": ['Theme'],
        },
        "Catabolism": {
            "event type": "Catabolism",
            "keywords": [],
            "event description": "The event is related to catabolism, where larger molecules are broken down into smaller units, releasing energy.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "Theme {ROLE_Theme} undergoes catabolism.",
            "valid roles": ['Theme'],
        },
        "Cell_division": {
            "event type": "Cell_division",
            "keywords": [],
            "event description": "Cell division refers to the biological process where a single cell divides into two or more daughter cells. This process is essential for growth, development, and tissue repair in multicellular organisms. It includes stages such as mitosis or meiosis and cytokinesis.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes division, resulting in the production of daughter cells.",
            "valid roles": ['Theme'],
        },
        "Cell_proliferation": {
            "event type": "Cell_proliferation",
            "keywords": [],
            "event description": "Cell proliferation refers to the process by which cells grow and divide to produce new cells. This process is essential for tissue growth, regeneration, and repair, and is tightly regulated to maintain proper organismal function.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes proliferation, contributing to tissue growth or repair.",
            "valid roles": ['Theme'],
        },
        "DNA_methylation": {
            "event type": "DNA_methylation",
            "keywords": [],
            "event description": "DNA methylation is an epigenetic modification involving the addition of a methyl group to the DNA molecule, typically at cytosine residues in CpG dinucleotides. This process plays a key role in regulating gene expression, maintaining genomic stability, and influencing cellular differentiation.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At the site {ROLE_Site}, the theme {ROLE_Theme} undergoes methylation, which may influence gene expression or genomic stability.",
            "valid roles": ['Site', 'Theme'],
        },
        "Death": {
            "event type": "Death",
            "keywords": [],
            "event description": "Death refers to the irreversible cessation of biological functions in a living organism or cell. In a biomedical context, this event can occur at the cellular level (apoptosis or necrosis) or at the organismal level due to disease, injury, or programmed cell death mechanisms.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes death, leading to the loss of biological function.",
            "valid roles": ['Theme'],
        },
        "Dephosphorylation": {
            "event type": "Dephosphorylation",
            "keywords": [],
            "event description": "Dephosphorylation is a biochemical process involving the removal of a phosphate group from a molecule, typically a protein or other biomolecule. This reaction is catalyzed by phosphatases and plays a crucial role in regulating cellular signaling pathways, enzyme activity, and metabolic processes.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At the site {ROLE_Site}, the theme {ROLE_Theme} undergoes dephosphorylation, which can alter its function or activity in cellular processes.",
            "valid roles": ['Site', 'Theme'],
        },
        "Development": {
            "event type": "Development",
            "keywords": [],
            "event description": "Development refers to the process of biological growth and differentiation, where an organism, tissue, or cell undergoes structural and functional changes over time. This process is critical for embryogenesis, organogenesis, and overall maturation, and is regulated by genetic and environmental factors.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes development, leading to changes in structure, function, or differentiation.",
            "valid roles": ['Theme'],
        },
        "Dissociation": {
            "event type": "Dissociation",
            "keywords": [],
            "event description": "Dissociation refers to the process by which a complex molecule or compound separates into smaller units, such as individual molecules, atoms, or ions. This process can occur in biological systems, chemical reactions, or molecular interactions, often affecting cellular functions and biochemical pathways.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes dissociation, resulting in the separation of its components.",
            "valid roles": ['Theme'],
        },
        "Gene_expression": {
            "event type": "Gene_expression",
            "keywords": [],
            "event description": "Gene expression is the process by which genetic information encoded in DNA is transcribed into RNA and translated into proteins. This process is tightly regulated and plays a crucial role in cellular function, differentiation, and response to environmental stimuli.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes gene expression, leading to the production of functional RNA or proteins.",
            "valid roles": ['Theme'],
        },
        ...
        "Growth": {
            "event type": "Growth",
            "keywords": [],
            "event description": "Growth refers to the increase in size, mass, or number of cells within an organism, tissue, or cell population. This process is influenced by genetic, hormonal, and environmental factors and is essential for development, regeneration, and adaptation.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes growth, resulting in an increase in size, number, or function.",
            "valid roles": ['Theme'],
        },
        "Localization": {
            "event type": "Localization",
            "keywords": [],
            "event description": "The event is related to localization, where a substance or organism is transported to a specific location within the organism.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At Loc {ROLE_AtLoc}, from Loc {ROLE_FromLoc}, the theme {ROLE_Theme} moves to Loc {ROLE_ToLoc}.",
            "valid roles": ['AtLoc', 'FromLoc', 'Theme', 'ToLoc'],
        },
        "Metabolism": {
            "event type": "Metabolism",
            "keywords": [],
            "event description": "Metabolism refers to the complex set of biochemical reactions that occur within a living organism to maintain life. It includes catabolic processes that break down molecules to release energy and anabolic processes that synthesize complex molecules necessary for cellular function, growth, and maintenance.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes metabolic processes, involving energy production or biosynthesis of essential molecules.",
            "valid roles": ['Theme'],
        },
        "Negative_regulation": {
            "event type": "Negative_regulation",
            "keywords": [],
            "event description": "The event involves the process of reducing or inhibiting the activity of a biological function.",
            "ED template": "Event trigger is {Trigger}.",
        ...
        "Pathway": {
            "event type": "Pathway",
            "keywords": [],
            "event description": "The event is related to a biological pathway involving multiple participants.",
            "ED template": "Event trigger is {Trigger}.",
        ...
        "Phosphorylation": {
            ...
            "keywords": [],
            "event description": "Phosphorylation is a biochemical process in which a phosphate group is added to a molecule, typically a protein or other biomolecule. This reaction is catalyzed by kinases and plays a crucial role in cellular signaling, enzyme activation, and metabolic regulation.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At the site {ROLE_Site}, the theme {ROLE_Theme} undergoes phosphorylation, which may regulate its activity or function in signaling pathways.",
            "valid roles": ['Site', 'Theme'],
        },
        "Planned_process": {
            "event type": "Planned_process",
            "keywords": [],
            "event description": "The event involves a deliberate and structured process with specified instruments and themes.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "Using instrument {ROLE_Instrument} and instrument 2 {ROLE_Instrument2}, the planned process is applied to theme {ROLE_Theme} and theme 2 {ROLE_Theme2}.",
            "valid roles": ['Instrument', 'Instrument2', 'Theme', 'Theme2'],
        },
        "Positive_regulation": {
            "event type": "Positive_regulation",
            "keywords": [],
            "event description": "The event involves the enhancement or activation of a biological function.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At CSite {ROLE_CSite}, the cause {ROLE_Cause} acts on site {ROLE_Site} to positively regulate theme {ROLE_Theme} and theme 2 {ROLE_Theme2}.",
            "valid roles": ['CSite', 'Cause', 'Site', 'Theme', 'Theme2'],
        },
        "Protein_processing": {
            "event type": "Protein_processing",
            "keywords": [],
            "event description": "Protein processing refers to the post-translational modifications and structural changes that occur after a protein is synthesized. This includes processes such as folding, cleavage, phosphorylation, glycosylation, and ubiquitination, which are essential for proper protein function and stability.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes processing, which may include modifications affecting its structure or function.",
            "valid roles": ['Theme'],
        },
        "Regulation": {
            "event type": "Regulation",
            "keywords": [],
            "event description": "Regulation refers to the control or modulation of a biological process, such as gene expression, enzyme activity, or signal transduction. It can be influenced by internal or external factors, including molecular interactions and environmental stimuli.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At the site {ROLE_Site}, the theme {ROLE_Theme} is regulated by the cause {ROLE_Cause}, potentially influenced by {ROLE_CSite}.",
            "valid roles": ['CSite', 'Cause', 'Site', 'Theme'],
        },
        "Remodeling": {
            "event type": "Remodeling",
            "keywords": [],
            "event description": "The event involves the control or modulation of a biological process.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At CSite {ROLE_CSite}, the cause {ROLE_Cause} influences the site {ROLE_Site} to regulate the theme {ROLE_Theme}.",
            "valid roles": ['Theme'],
        },
        "Reproduction": {
            "event type": "Reproduction",
            "keywords": [],
            "event description": "The event involves the biological process through which new organisms are produced.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} is involved in reproduction.",
            "valid roles": ['Theme'],
        },
        "Synthesis": {
            "event type": "Synthesis",
            "keywords": [],
            "event description": "Synthesis refers to the biological process in which complex molecules, such as proteins, nucleic acids, or metabolites, are constructed from simpler precursor molecules. This process is essential for cellular growth, repair, and function.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} is synthesized, contributing to cellular processes and functionality.",
            "valid roles": ['Theme'],
        },
        "Transcription": {
            "event type": "Transcription",
            "keywords": [],
            "event description": "Transcription is the process by which genetic information encoded in DNA is copied into messenger RNA (mRNA) by RNA polymerase. This is the first step in gene expression and is tightly regulated to ensure precise protein production.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes transcription, producing mRNA for subsequent translation.",
            "valid roles": ['Theme'],
        },
        "Translation": {
            "event type": "Translation",
            "keywords": [],
            "event description": "Translation is the biological process in which ribosomes decode messenger RNA (mRNA) to synthesize proteins. This process is essential for protein production and is regulated at multiple levels to ensure accurate gene expression.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes translation, resulting in the synthesis of a functional protein.",
            "valid roles": ['Theme'],
        },
        "Ubiquitination": {
            "event type": "Ubiquitination",
            "keywords": [],
            "event description": "Ubiquitination is a post-translational modification in which ubiquitin molecules are covalently attached to a target protein. This process is critical for protein degradation, cellular signaling, and regulation of various biological functions.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes ubiquitination, which may regulate its stability, localization, or activity.",
            "valid roles": ['Theme'],
        },
    },
    "genia2011": {
        "Binding": {
            "event type": "Binding",
            "keywords": [],
            "event description": "The event involves the interaction where multiple themes bind together, potentially at specific sites.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At site {ROLE_Site} and site 2 {ROLE_Site2}, theme {ROLE_Theme} binds with theme 2 {ROLE_Theme2}, theme 3 {ROLE_Theme3}, and theme 4 {ROLE_Theme4}.",
            "valid roles": ['Site', 'Site2', 'Theme', 'Theme2', 'Theme3', 'Theme4'],
        },
        "Gene_expression": {
            "event type": "Gene_expression",
            "keywords": [],
            "event description": "Gene expression is the process by which genetic information encoded in DNA is transcribed into RNA and subsequently translated into proteins or functional RNA molecules. This tightly regulated process plays a fundamental role in cellular function, differentiation, and response to environmental stimuli.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes gene expression, leading to the production of RNA or proteins necessary for cellular functions.",
            "valid roles": ['Theme'],
        },
        "Localization": {
            "event type": "Localization",
            "keywords": [],
            "event description": "The event involves the process where a theme is localized or directed to a specific location.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At location {ROLE_AtLoc}, the theme {ROLE_Theme} is directed to location {ROLE_ToLoc}.",
        ...
        "Negative_regulation": {
            ...
            "event description": "The event involves the process of reducing or inhibiting the activity of a biological function.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At CSite {ROLE_CSite}, the cause {ROLE_Cause} negatively influences the site {ROLE_Site} to inhibit the theme {ROLE_Theme}.",
            "valid roles": ['CSite', 'Cause', 'Site', 'Theme'],
        },
        "Phosphorylation": {
            "event type": "Phosphorylation",
            "keywords": [],
            "event description": "The event involves the addition of a phosphate group to a theme, typically a protein, often at a specific site.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At site {ROLE_Site}, the theme {ROLE_Theme} undergoes phosphorylation.",
            "valid roles": ['Site', 'Theme'],
        },
        "Positive_regulation": {
            "event type": "Positive_regulation",
            ...
            "event description": "The event involves the enhancement or activation of a biological function.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At CSite {ROLE_CSite}, the cause {ROLE_Cause} acts on site {ROLE_Site} to positively regulate the theme {ROLE_Theme}.",
            "valid roles": ['CSite', 'Cause', 'Site', 'Theme'],
        },
        "Protein_catabolism": {
            "event type": "Protein_catabolism",
            "keywords": [],
            "event description": "Protein catabolism is the biological process in which proteins are broken down into their constituent amino acids through proteolysis. This process is essential for cellular homeostasis, recycling of amino acids, and the regulation of protein levels in response to metabolic needs.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "The theme {ROLE_Theme} undergoes protein catabolism, leading to the breakdown of proteins into amino acids for reuse or energy production.",
            "valid roles": ['Theme'],
        },
        "Regulation": {
            "event type": "Regulation",
            ...
            "event description": "The event involves the control or modulation of a biological process.",
            "ED template": "Event trigger is {Trigger}.",
            "EAE template": "At CSite {ROLE_CSite}, the cause {ROLE_Cause} influences site {ROLE_Site} to regulate the theme {ROLE_Theme}.",
            "valid roles": ['CSite', 'Cause', 'Site', 'Theme'],
        },
        "Transcription": {
            "event type": "Transcription",
        "keywords": [],
        "event description": "The event involves the process of copying genetic information from DNA to RNA.",
        "ED template": "Event trigger is {Trigger}.",
        "EAE template": "The theme {ROLE_Theme} undergoes transcription.",
            "valid roles": ['Theme'],
        },
    },
    "genia2013": {
